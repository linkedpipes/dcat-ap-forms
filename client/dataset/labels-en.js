...
export default {
  ...
  "help_license_db_type": "<h3>Database protected by copyright</h3><p>This item is governed by a <a href=\"https://data.gov.cz/pro-poskytovatele/otevřená-data/stanovení-podmínek-užití/#autorskoprávní-ochrana-databáze-jako-díla\" target=\"_blank\">detailed guide (in Czech only)</a>. Filling the correct values is crucial for the usability and openness of the distribution. For this reason, pay maximum attention to the values selected here.</p>",
