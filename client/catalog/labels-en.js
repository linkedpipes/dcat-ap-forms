export default {
    ...
    "catalog_summary_download": "Download the catalog registration record and send it as an attachment of a data message with the subject \"NKOD\" to the databox ",
    ...
    "catalog_delete_summary_download": "If you are certain that you want to remove the local open data catalog registration, send the downloaded file as an attachment of a data message with the subject \"NKOD\" to the databox ",
    "step_download": "Summary",
    "button_download": "Download",
    "summary_download": "Download the registration file and send it as an attachment of a data message with the subject \"NKOD\" to the databox ",
