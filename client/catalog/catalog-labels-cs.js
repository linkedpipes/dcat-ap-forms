...
export default {
  ...
  "catalog_title_cs": "Název lokálního katalogu otevřených dat česky",
  "catalog_title_en": "Název lokálního katalogu otevřených dat anglicky (volitelné)",
  ...
  "help_catalog_type": "<h3>Typ API lokálního katalogu</h3><p>Rozhraní katalogu otevřených dat musí splňovat <a href=\"https://data.gov.cz/otevřené-formální-normy/rozhraní-katalogů-otevřených-dat/\" target=\"_blank\">otevřenou formální normu pro rozhraní katalogů otevřených dat</a>. V současnosti jsou podporovány 2 typy LKOD API - DCAT-AP Dokumenty a DCAT-AP SPARQL Endpoint.</p>",
  ...
  "catalog_edit_page_title": "Registrace lokálního katalogu do NKOD",
