...
export default {
  ...
  "mode_notice_default": "You are filling out a registration record for an open dataset.",
  ...
  "hint_landing_page": "Enter the HTTPS URL of the web page that can be accessed through a web browser to get access to the dataset, its distributions, and/or additional information.",
