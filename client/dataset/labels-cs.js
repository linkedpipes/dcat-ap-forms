export default {
  ...
  "hint_temporal": "PLACEHOLDER: HINT",
  "temporal_invalid": "PLACEHOLDER: INVALID TEMPORAL",
  "spatial_resolution_meters": "Prostorové rozlišení v metrech",
  "hint_spatial": "PLACEHOLDER: HINT",
  "spatial_invalid": "PLACEHOLDER: INVALID SPATIAL",
  ...
  "help_temporal": "<h3>Časové rozlišení</h3><p>Minimum time period resolvable in the dataset. Tato vlastnost obvykle značí nejmenší časový rozdíl mezi položkami datové sady. If the dataset is a time-series this should correspond to the spacing of items in the series.</p><p≥PLACEHOLDER jak vytvořit platný řetězec.</p>",
