...
export default {
  ...
  "mode_notice_default": "You are filling out a registration record for a dataset.",
  "mode_notice_hvd": "You are filling out a registration record for a high value dataset.",
  "mode_notice_non_public": "You are filling out a registration record for a non-public dataset",
  "landing_title": "Dataset registration",
  "landing_description": "Select the type of dataset you want to register, or load an existing record from a file or URL.",
  "landing_mode_open_data": "Open data dataset",
  ...
  "landing_import_description": "Or load an existing registration record from a file or URL.",
  "upload_from_file": "Load record from file",
  "upload_from_file_hint": "Click and select a file",
  ...
  "help_dataset_keyword": "<h3>Keywords</h3><p>Keywords characterize the published dataset. The enable data consumers to search for related datasets in the whole National Data Catalog. They should therefore not be internal identifiers used only by the publisher. On the contrary, they should be words which would be selected by the most data consumers to describe the dataset. For inspiration, see other registered datasets in the National Data Catalog.</p>",
  ...
  "landing_page_invalid": "Invalid landing page URL.",
  "themes": "EuroVoc concepts",
  "distribution_hvd": "High Value Dataset (HVD)",
  ...
  "summary_nkod_download": "Download the registration record and send it as an attachment of a data message with \".txt\" extension and the subject \"NKOD\" to the databox ",
  "summary_nkod_download_tail": "Received records are processed in batches, typically over night.",
  "summary_lkod_download": "Save the catalog record to your local data catalog.",
  "button_download": "Download",
  "download_new_nkod": "Download new NDC record",
  "download_edit_nkod": "Download NOC editing record",
  "download_edit_lkod": "Download LDC editing record",
  "download_new_lkod": "Download new LDC record",
  ...
  "help_landing_page": "<h3>Landing page</h3><p>A web page which can be accessed through a web browser to get access to the dataset, its distributions, and/or additional information. This may be, for example, a page in a local data catalog.</p>",
  ...
  "help_dataset_ofn": "<h3>Specification</h3><p>If the dataset uses <a href=\"https://ofn.gov.cz\" target=\"_blank\">formal open norms and shared specifications</a>, specify their URLs here. Only then will the applications searching NDC be able to find your data. Specify them with diacritics, version and a slash at the end like this: <code>https://ofn.gov.cz/turistické-cíle/2020-07-01/</code></p>",
  "hint_themes": "Start typing the theme name.",
  "help_distribution_hvd": "<h3>HVD distribution</h3><p>A distribution covered by the HVD implementing regulation. A high-value dataset may also contain distributions that are outside the scope of the HVD implementing regulation, but it must contain at least one distribution that is in scope.</p>",
  "hint_documentation": "Enter an HTTPS URL of the web page containing detailed dataset documentation",
  "hint_landing_page": "Enter the HTTPS URL of dataset page in local data catalog",
  ...
  "help_license_author_type": "<h3>Copyrighted work</h3><p>This item is governed by a <a href=\"https://data.gov.cz/otevřená-data/pro-poskytovatele/stanovení-podmínek-užití/#autorská-práva\" target=\"_blank\">detailed guide (in Czech only)</a>. If you select &quot;Contains multiple copyrighted works&quot;, please make sure that for each copyrighted work in the distribution, there is a license clearly specified.</p>",
  ...
  "help_license_db_type": "<h3>Database protected by copyright</h3><p>This item is governed by a <a href=\"https://data.gov.cz/otevřená-data/pro-poskytovatele/stanovení-podmínek-užití/#autorskoprávní-ochrana-databáze-jako-díla\" target=\"_blank\">detailed guide (in Czech only)</a>.</p>",
  ...
  "help_license_specialdb_type": "<h3>Sui generis database rights</h3><p>This item is governed by a <a href=\"https://data.gov.cz/otevřená-data/pro-poskytovatele/stanovení-podmínek-užití/#zvláštní-práva-pořizovatele-databáze\" target=\"_blank\">detailed guide (in Czech only)</a>.</p>",
  ...
  "edit_page_title_nkod": "Edit of an NDC registered dataset",
  "edit_page_title_lcod": "Edit of an LDC registered dataset",
  "edit_page_title_new": "Register a new dataset",
  "edit_page_title_new_lkod": "Register a new LDC dataset",
  "delete_page_title": "Removal of a dataset from NDC",
  "dataset_delete_summary_download": "If you are certain that you want to remove this dataset from the NDC, send the downloaded file as an only attachment of a data message with \".txt\" extension and the subject \"NKOD\" to the databox ",
  "personal_invalid": "For registration of a distribution in NDC it is neccessary to clearly specify whether or not the distribution contains personal data. The value \"May contain personal data\" is only for indication of a legacy record which needs to be further specified.",
  ...
  "upload_from_url": "Load record from URL",
  ...
  "isvs": "ISVS",
  "isvs_autocomplete_no_data": "Start typing the name of the ISVS.",
  "help_isvs": "<h3>ISVS</h3><p>Information system of public administration (ISVS) that includes this dataset.</p>",
  "missing_isvs": "ISVS is mandatory.",
  "related_terms": "Related terms",
  "related_terms_autocomplete_no_data": "Start typing the name of the related term.",
  "missing_related_terms": "At least one related term must be selected.",
  ...
  "add_zprostredkovava_sdileni": "Add intermediary sharing",
  "zprostredkovava_sdileni_incomplete": "All fields in an intermediary sharing entry are mandatory.",
  // Service title
  "copy_service_title": "Copy data serice title from distribution",
  "service_title_missing": "Data service title is mandatory.",
  "service_title_invalid": "Data service title is mandatory.",
  "service_title_cs": "Data service title in Czech",
  "service_title_en": "Data service title in English",
  "hint_service_title": "It should be concise and descriptive.",
  ...
  "hint_distribution_documentation": "HTTPS URL of the QoS documentation of the data service.",
