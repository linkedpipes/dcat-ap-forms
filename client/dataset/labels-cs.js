export default {
  ...
  "help_temporal": "<h3>Časové rozlišení</h3><p>Nejmenší časový rozdíl mezi položkami datové sady.</p><p>Hodnota se zaadává ve formátu PnYnMnDTnHnMnS. P značí zaačátek výrazu, nY je počet let následovaný literálem Y, nM je počet měsíců následovaný literálem M, nD je počet dní následovaný literálem D, T odděluje datum a čas, nH je počet hodin následovaný literálem H, nM je počet minut následovaný literálem M, nS je počet vteřin následovaný literálem S. Je-li některá hodnota 0, může číslo a následný literál chybět. Alespoň jedno číslo a následný literál však musí být obsaženo. Čísla jsou kladná celá s výjimkou vteřin, které mohou být kladná desetinná. Objeví-li se v počtu vteřin desetinná tečka, musí za ní následovat alespoň jedna další číslice. Znaménko minus se může objevit před P. Pokud nejsou uvedeny žádné časové položky, písmeno T se neuvádí.</p>",
  "help_spatial": "<h3>Prostorové rozlišení</h3><p>Nejmenší prostorová vzdálenost v metrech mezi položkaami datové sady.</p><p>Pro obrázek nebo matici jde o rozestupy mezi položkami, pro jiné datové sady hodnota typicky udává nejmenší vzdálenost mezi položkami datové sady.</p>",
